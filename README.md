...
pg_host = IP OF THE SYSTEM WHERE DB IS HOSTED
...
VITE_AUTH_API_BASE_URL=SYSTEM_IP:APP_PORT
VITE_CHART_BASE_URL=SYSTEM_IP:APP_PORT
VITE_CHART_OLD_BASE_URL=SYSTEM_IP:APP_OLD_PORT
